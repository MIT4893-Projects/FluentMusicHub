...
{
    public sealed partial class HomeButtonView : UserControl, ISidebarNavigationItem
    {
        ...
        {
            Uri unselectingImageSource = new("ms-appx:///Assets/home-outline-size-48-white.png");
            Uri selectingImageSource = new("ms-appx:///Assets/home-fill-size-48-white.png");
